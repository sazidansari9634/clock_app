...
class ClockView extends StatefulWidget {
 ...
 class ClockPainter extends CustomPainter { 
  ...
  //60 sec - 306, 1 sec - 6degree
  //12 hours  - 360 1 hour - 30degress, 1 min -0.5degress
  ...
  void paint(Canvas canvas, Size size) {
    ...
    ..shader = RadialGradient(colors: [Color(0xFFA74AB), Color(0xFFC279FB)]).createShader(Rect.fromCircle(center: center, radius: radius))
    ..style = PaintingStyle.stroke
    ..strokeCap = StrokeCap.round
    ..strokeWidth = 12;

    var dashBrush = Paint()
    ..color = Color.fromARGB(247, 247, 248, 248)
    // ..color = Color(0xFFFFF)
    ..style = PaintingStyle.stroke
    ..strokeCap = StrokeCap.round
    ..strokeWidth = 2;
